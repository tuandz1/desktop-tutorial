                        ...
                        <div class="card-body">
                            <form id="validationform" action="updateAccount"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="ans" required="" value="${ac.answer}" placeholder="Input Answer" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Acc_Name</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="acc_name" placeholder="Login Name" value="${ac.acc_name}"  required=""   class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Password</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input required="" type="password" name="pass" value="${ac.cus_password}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="full_name" required="" value="${ac.full_name}" placeholder="Input Full Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input required="" type="email" value="${ac.email}" name="mail" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Telephone</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input required="" type="tel" value="${ac.phone}" name="phone" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea required="" name="add" class="form-control">${ac.address}</textarea>
                                    </div>
                                </div>
