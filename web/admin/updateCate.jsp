                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav flex-column">
                               ...
                               <li class="nav-item ">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link active" href="catemanage" ><i class="fa fa-fw fa-user-circle"></i>Category Manage </a>
            ...
            <div class="dashboard-wrapper">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="validationform" action="updateCate"  method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="name" value="${ca.ca_name}" required="" placeholder="Input Name" class="form-control">
                                    </div>
                                </div>
