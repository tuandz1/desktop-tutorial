 ...
 * @author admin
 */
@WebServlet(name = "updateVoucher", urlPatterns = {"/updateVoucher"})
public class updateVoucher extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String start = request.getParameter("startdate");
        ...
        dao.updateVoucher(id, formattedStartDate, formattedEndDate,( rate / 100.0), amount,oldid);
        HttpSession session = request.getSession();
        session.setAttribute("messvo", "Update sucessfull!");
