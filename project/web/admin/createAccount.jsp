                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="validationform" action="createAccount"  method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="ans" required="" placeholder="Input Answer" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Acc_Name</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="acc_name" placeholder="Login Name"  required=""   class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="full_name" required="" placeholder="Input Full Name" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea required="" name="add" class="form-control"></textarea>
                                    </div>
                                </div>
