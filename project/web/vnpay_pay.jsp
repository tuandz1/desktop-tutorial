        ...
        <div class="container">
            ...
            <div class="card">
                ...
                <h5 class="card-header">
                    ...
                    <strong style="font-size: 25px; text-align: center; color: #ff6666; font-family: sans-serif"><fmt:formatNumber value="${o.getTotalMoney(sessionScope.acc.id)}" type="number" pattern="#,##0" />đ</strong>
                </h5>
