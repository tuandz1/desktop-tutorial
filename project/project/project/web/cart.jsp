    ...
    <body class="home">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center">
                                        <c:if test="${i.quantity > 1}">
                                            <button class="quantity-button" onclick="location.href = 'quantity?num=-1&id=${i.product.id}&acc_num=${sessionScope.acc.id}'">-</button>
                                        </c:if>
                    ...
                    <c:if test="${o.items.size() == 0}">
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 20px;">
                                Your cart is empty. <br><!-- comment -->
                                Countinue Shopping &nbsp;  <a href="home" style="text-decoration: red; color: red" class="btn btn-action">
                                    Click here
                                </a>
                            </td>
                        </tr>
        ...
        <style>
            ...
            .quantity-button {
                ...
                margin: 0 5px; /* Add some margin between buttons and quantity text */
