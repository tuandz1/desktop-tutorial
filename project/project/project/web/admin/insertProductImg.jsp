        ...
        <div class="dashboard-main-wrapper">
            ...
            <div class="dashboard-wrapper">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Insert Product Image ${name}</h5>
                        <div class="card-body">
                            <form id="uploadForm" action="insertProductImage"  method="post" enctype="multipart/form-data">

                                <div class="form-group row">
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="hidden" name="name" value="${name}" required="" placeholder="Input Name" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input required="" type="file" name="imgs" id="fileInput" multiple accept="image/*" class="form-control">
                                    </div>
