                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <div class="row">
                                    <a href="catemanage?action=1" class="col-2 btn btn-primary"><i class="  fas fa-plus-circle"></i> Add Category</a>
                                     &nbsp;
                                    <button id="exportBtn" class="col-2 btn btn-primary"><i class="  fas fa-plus-circle"></i> export to file</button>
                                    <form class="col-12 form-control" action="catemanage"method="post">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> 
                                                                ...
                                                                <div class="modal fade" id="exampleModal${a.id}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <a href="catemanage?action=3&cid=${a.id}" class="btn btn-secondary" >Delete</a>
                                                                  ...
                                                                  &nbsp; 
                                                                <a href="catemanage?action=2&cid=${a.id}" class="btn btn-outline-success"><i class=" fas fa-edit"></i></a>
