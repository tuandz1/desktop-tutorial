            ...
            <div class="dashboard-wrapper">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="validationform" action="updateBrand"  method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class=" col-sm-7  text-sm-right ">
                                        <img  style="width: auto; height: 200px" src="${bra.brand_img}" alt="alt"/>
                                    </div>
                                </div>
                               
                                <input type="hidden" value="${bra.id}" name="id">
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Brand Name</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" name="name" value="${bra.brand_name}" required="" placeholder="Input Name" class="form-control">
                                    </div>
                                </div>
